...
dev.print(png, "figures/ASV.range.png", units="in", width=6, height=5, res=300)
dev.off()
```

Additional taxonomy summary for abundance-occupancy data, used in Supplementary Figures 4 and 5
```{r, taxonomy, results="hide", message=FALSE, fig.dim=c(6,5)}
...
### Bacteria phyla plot
par(mfrow=c(2,1), mar=c(4,10,1,1)+0.1)

# Bacteria rangespan
boxplot(bactaxrange$rangespan~bacphybymedrange, las=2, horizontal=TRUE, frame=F, cex.main=1,
        main="Distribution of Bacteria Phyla", col="gray48", cex=0.4, medlwd=1.5,
        xaxt="n", tck=-0.03, xlab="Range (m)", ylab="", cex.axis=0.6, cex.lab=0.8)
axis(side=1, labels=T, seq(0,5500, by=1000), cex.axis=0.6, cex.lab=0.6, tck=-0.03)


# Bacteria habitats
boxplot(bactaxrange$habitats~bacphybymedhab, las=2, horizontal=TRUE, frame=F, xaxt="n", tck=-0.03,
        col="gray48", xlab="Habitats", cex.axis=0.6, cex.lab=0.8, ylab="", cex=0.4, medlwd=1.5)
axis(side=1, labels=T, seq(0,8, by=1), cex.axis=0.6, cex.lab=0.6, tck=-0.03)

dev.copy(png, "figures/BactTax.range.hab.png", units="in", width=6, height=7, res=300)
dev.off()
...
boxplot(funtaxrange$rangespanF~funphybymedrange,las=2, horizontal=TRUE, frame=F, cex.main=1,
        main="Distribution of Fungal Classes", col="gray84", cex=0.4, medlwd=1.5,
        xaxt="n", tck=-0.03, xlab="Range (m)", ylab="", cex.axis=0.6, cex.lab=0.8)
axis(side=1, labels=T, seq(0,5500, by=1000), cex.axis=0.6, cex.lab=0.6, tck=-0.03)

# Fungi habitats
boxplot(funtaxrange$habitatsF~funphybymedhab, las=2, horizontal=TRUE, frame=F, xaxt="n", tck=-0.03,
        col="gray84", xlab="Habitats", cex.axis=0.6, cex.lab=0.8, ylab="", cex=0.4, medlwd=1.5)
axis(side=1, labels=T, seq(0,8, by=1), cex.axis=0.6, cex.lab=0.6, tck=-0.03)

dev.copy(png, "figures/FungTax.range.hab.png", units="in", width=6, height=7, res=300)
dev.off()
```


#### Rangespan of microbiome communities  
Now create a plot for rangespan--the range in meters for each ASV--and the frequency of phytobiomes for bacteria and fungi.  
...
par(mfrow=c(1,2), mar=c(8,1,3,1))

#First plot: Bacterial rangespan
boxplot(rangespan, horizontal=TRUE, vertical=TRUE, col="gray48", main="Bacteria", frame=F, cex=0.5, cex.lab=0.4, xlab="ASV range (m)", cex.main=0.5, xaxt="n", medlwd=1.5)
axis(side=1, labels=T, seq(0,5000, by=1000), cex.axis=0.4, tck=-0.04)

#Second Plot: Fungal rangespan
boxplot(rangespanF, horizontal=TRUE  , col="gray84", main="Fungi", frame=F, cex.main=0.5, xlab="ASV range (m)", xaxt="n", cex=0.2, cex.lab=0.4, medlwd=1.5, pch=16)
axis(side=1, labels=T, seq(0,5000, by=1000), cex.axis=0.4, tck=-0.04)

#Add title to figure!
title(main = "Rangespan of Phytobiome Communities", outer = TRUE, line = -0.5, cex.main=0.5)

dev.copy(png, "figures/community.rangespan.png", units="in", width=4, height=3, res=300)
dev.off()
```
...
plot(nested, kind="incid", names=c(TRUE,FALSE), col=c("white", "gray48"), lwd=3, main="Bacteria Nested Plot")
#add stats are margin text
mtext("Nested Temp=39.8, P=0.001")
#plot the fungal nested figure, suppress taxon names
plot(funnested, kind="incid", names=c(TRUE,FALSE), col=c("white", "gray84"), lwd=3, main="Fungi Nested Plot")
...
plot_grid(NMDS.plots, NMDS.legend, rel_widths = c(3, 1)) # legend  1/3 size as first obj.
dev.copy(pdf, "figures/NMDS.figBW.pdf", width = 6, height = 4)
```
