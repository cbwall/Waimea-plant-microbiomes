...
dev.print(png, "figures/FigS3. Community.mantel.png", units="in", width=4, height=4, res=300)
dev.off()
...
dev.print(png, "figures/Fig4. ASVrangespan.png", units="in", width=6, height=5, res=300)
dev.off()
```
...
dev.copy(png, "figures/FigS4. BactTax.range.hab.png", units="in", width=6, height=7, res=300)
dev.off()
...
dev.copy(png, "figures/FigS5.FungTax.range.hab.png", units="in", width=6, height=7, res=300)
dev.off()
```
...
dev.print(png, "figures/Fig3. Nestedplots.png", units="in", width=6, height=6, res=300)
dev.off()
...
bac.NMDS<-plot_ordination(phyobj.hell, phyobj.ord, type="samples", shape="SampleType", title="Bacteria") +
  ...
  theme(legend.position="none") + coord_equal(ratio=2.5) +
  theme_bw()
