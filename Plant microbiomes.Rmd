...
f_conditions <- as.matrix(read.csv("output/volcano/VP_Fungi_Metadata.csv", sep = ",", header = TRUE))

b_conditions <- as.matrix(read.csv("output/volcano/VP_Bacteria_Metadata.csv", sep = ",", header = TRUE))
...
fungi_taxonomy <- read.csv("output/volcano/consensus_taxonomy.csv")
bacteria_taxonomy <- read.csv("output/volcano/bacteria_parametricDESeq_AllOTU.csv") 
