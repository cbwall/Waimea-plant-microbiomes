...
```{r, SiteMap_Script_AustinGreene, results="hide"}
...
```{r, fungibacteria_mantel, results="hide", fig.dim=c(5,5)}
# Code by Anthony
...
#### Bacterial and fungal abundance-occupancy  
Generate abundance-occupancy graphs with bacteria and fungal data with site locations, which are scaled the mean-annual precipitation.  
  
```{r, Bacterial and Fungal Abundance Occupancy, results='hide'}
# Code by Anthony
...
```{r, plots for Habitat VS ESV range, results="hide", message=FALSE, fig.dim=c(5,8)}
...
#Add title to figure!
title(main = "Rangespan of Phytobiome Communities", outer = TRUE, line = -1)
