...
write.csv(sub_bacteria, file = "data/mvabund/sub_bacteria.csv", row.names = F)	#Save df
#sub_bacteria <- read.csv("data/mvabund/sub_bacteria.csv")	#Read in if saved
...
write.csv(fun_count_df, file = "data/mvabund/fun_count_df.csv", row.names = F)	#Save df
#fun_count_df <- read.csv("data/mvabund/fun_count_df.csv", header = T)	#Read in df if saved
...
write.csv(sub_fungi, file = "data/mvabund/sub_fungi.csv", row.names = F)	#Save df
#sub_fungi <- read.csv("data/mvabund/sub_fungi.csv")	#Read in if saved
...
pdf(file = "figures/mvabundXtra/bac_gradient_residuals.pdf")	#Prepare to save image
...
write.csv(bac_gradient.df, file = "output/mvabund/bac_gradient.df.csv", row.names = F)	#Save p-values
bac_gradient_spp = colnames(bac_gradient.df)[bac_gradient.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_gradient_spp, file = "output/mvabund/bac_gradient_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_gradient.df, file = "output/mvabund/q_bac_gradient.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_gradient, file = "output/mvabund/sigbac_gradient.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(sigbacgrad.df, file = "output/mvabund/sigbacgrad.df.csv", row.names = F)	#Save df
...
pdf(file = "figures/mvabundXtra/sigbacgrad_coefplot.pdf")	#Prepare to save plot
...
pdf(file = "figures/mvabundXtra/sigbacgrad.pdf")	#Prepare to save plot
...
write.csv(bac_air.df, file = "output/mvabund/bac_air.df.csv", row.names = F)	#Save p-values
bac_air_spp = colnames(bac_air.df)[bac_air.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_air_spp, file = "output/mvabund/bac_air_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_air.df, file = "output/mvabund/q_bac_air.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_air, file = "output/mvabund/sigbac_air.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(bac_soil.df, file = "output/mvabund/bac_soil.df.csv", row.names = F)	#Save p-values
bac_soil_spp = colnames(bac_soil.df)[bac_soil.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_soil_spp, file = "output/mvabund/bac_soil_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_soil.df, file = "output/mvabund/q_bac_soil.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_soil, file = "output/mvabund/sigbac_soil.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(bac_root.df, file = "output/mvabund/bac_root.df.csv", row.names = F)	#Save p-values
bac_root_spp = colnames(bac_root.df)[bac_root.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_root_spp, file = "output/mvabund/bac_root_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_root.df, file = "output/mvabund/q_bac_root.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_root, file = "output/mvabund/sigbac_root.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_stem.df, file = "output/mvabund/q_bac_stem.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_stem, file = "output/mvabund/sigbac_stem.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(bac_axil.df, file = "output/mvabund/bac_axil.df.csv", row.names = F)	#Save p-values
bac_axil_spp = colnames(bac_axil.df)[bac_axil.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_axil_spp, file = "output/mvabund/bac_axil_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_axil.df, file = "output/mvabund/q_bac_axil.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_axil, file = "output/mvabund/sigbac_axil.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(bac_petiole.df, file = "output/mvabund/bac_petiole.df.csv", row.names = F)	#Save p-values
bac_petiole_spp = colnames(bac_petiole.df)[bac_petiole.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_petiole_spp, file = "output/mvabund/bac_petiole_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_petiole.df, file = "output/mvabund/q_bac_petiole.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_petiole, file = "output/mvabund/sigbac_petiole.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(bac_leaf.df, file = "output/mvabund/bac_leaf.df.csv", row.names = F)	#Save p-values
bac_leaf_spp = colnames(bac_leaf.df)[bac_leaf.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_leaf_spp, file = "output/mvabund/bac_leaf_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_leaf.df, file = "output/mvabund/q_bac_leaf.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_leaf, file = "output/mvabund/sigbac_leaf.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(bac_litter.df, file = "output/mvabund/bac_litter.df.csv", row.names = F)	#save p-values
bac_litter_spp = colnames(bac_litter.df)[bac_litter.df[2,]<=0.05]	#Select significant p-values
write.csv(bac_litter_spp, file = "output/mvabund/bac_litter_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_bac_litter.df, file = "output/mvabund/q_bac_litter.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbac_litter, file = "output/mvabund/sigbac_litter.csv", row.names = F)	#Save list of significant ESVs


pdf(file = "figures/mvabundXtra/bac_SampleType_residuals.pdf")	#Prepare pdf file
...
write.csv(bacsamp, file = "output/mvabund/bacsamp.csv", row.names = T)	#Save df of significant ESVs

##Bar graph of ESV numbers per class for each sample type
pdf(file = "figures/mvabundXtra/bacsamp.pdf")	#Prepare pdf file
...
write.csv(bac_rainsamp.p.df, file = "output/mvabund/bac_rainsamp.p.df.csv")	#Save p-values
sigbacrainsamp_spp = colnames(bac_rainsamp.p.df)[bac_rainsamp.p.df[4,]<=0.05]	#Select significant p-values
write.csv(sigbacrainsamp_spp, file = "output/mvabund/sigbacrainsamp_spp.csv")	#Save list of significant ESVs
...
write.csv(q_sigbacrainsamp.df, file = "output/mvabund/q_sigbacrainsamp.df.csv", row.names = F)	#Save q-values
...
write.csv(sigbacrainsamp, file = "output/mvabund/sigbacrainsamp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(sigbacrainsamp.df, file = "output/mvabund/sigbacrainsamp.df.csv", row.names = F)	#Save df
...
sigbacrainsamp.glm <- manyglm(sigbacrainsamp.abund ~ Gradient * Sample_type,
	family = "negative.binomial")	#Assess GLMs for significant ESVs
pdf(file = "figures/mvabundXtra/sigbacrainsamp_coefplot1.pdf")	#Prepare to save plot
par(mar=c(5,8,3,1))	#Change margins of imaging device
...
fun_gradient <- manyglm(sub_fun ~ sub_fungi$rain,
	family = "negative.binomial")	#Perform manyglm
pdf(figures/mvabundXtra/file = "fun_gradient_residuals.pdf")	#Prepare to save image
...
write.csv(fun_gradient.df, file = "output/mvabund/fun_gradient.df.csv", row.names = F)	#Save p-values
fun_gradient_spp = colnames(fun_gradient.df)[fun_gradient.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_gradient_spp, file = "output/mvabund/fun_gradient_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_gradient.df, file = "output/mvabund/q_fun_gradient.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_gradient, file = "output/mvabund/sigfun_gradient.csv", row.names = F)	#Save list of significant ESVs


##Represent strength of relationship between environment gradient
##and significantly associated fungal ESVs.
...
write.csv(sigfungrad.df, file = "output/mvabund/sigfungrad.df.csv", row.names = F)	#Save df
...
sigfungrad.glm <- manyglm(sigfungrad.abund ~ Gradient,
	family = "negative.binomial")	#Assess GLMs for significant ESVs
pdf(file = "figures/mvabundXtra/sigfungrad_coefplot.pdf")	#Prepare to save plot
...
pdf(file = "figures/mvabundXtra/sigfungrad.pdf")	#Prepare to save plot
...
write.csv(fun_air.df, file = "output/mvabund/fun_air.df.csv", row.names = F)	#Save p-values
fun_air_spp = colnames(fun_air.df)[fun_air.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_air_spp, file = "output/mvabund/fun_air_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_air.df, file = "output/mvabund/q_fun_air.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_air, file = "output/mvabund/sigfun_air.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(fun_soil.df, file = "output/mvabund/fun_soil.df.csv", row.names = F)	#Save p-values
fun_soil_spp = colnames(fun_soil.df)[fun_soil.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_soil_spp, file = "output/mvabund/fun_soil_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_soil.df, file = "output/mvabund/q_fun_soil.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_soil, file = "output/mvabund/sigfun_soil.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(fun_root.df, file = "output/mvabund/fun_root.df.csv", row.names = F)	#Save p-values
fun_root_spp = colnames(fun_root.df)[fun_root.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_root_spp, file = "output/mvabund/fun_root_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_root.df, file = "output/mvabund/q_fun_root.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_root, file = "output/mvabund/sigfun_root.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(fun_stem.df, file = "output/mvabund/fun_stem.df.csv", row.names = F)	#Save p-values
fun_stem_spp = colnames(fun_stem.df)[fun_stem.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_stem_spp, file = "output/mvabund/fun_stem_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_stem.df, file = "output/mvabund/q_fun_stem.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_stem, file = "output/mvabund/sigfun_stem.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(fun_axil.df, file = "output/mvabund/fun_axil.df.csv", row.names = F)	#Save p-values
fun_axil_spp = colnames(fun_axil.df)[fun_axil.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_axil_spp, file = "output/mvabund/fun_axil_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_axil.df, file = "output/mvabund/q_fun_axil.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_axil, file = "output/mvabund/sigfun_axil.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(fun_petiole.df, file = "output/mvabund/fun_petiole.df.csv", row.names = F)	#Save p-values
fun_petiole_spp = colnames(fun_petiole.df)[fun_petiole.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_petiole_spp, file = "output/mvabund/fun_petiole_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_petiole.df, file = "output/mvabund/q_fun_petiole.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_petiole, file = "output/mvabund/sigfun_petiole.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(fun_leaf.df, file = "output/mvabund/fun_leaf.df.csv", row.names = F)	#Save p-values
fun_leaf_spp = colnames(fun_leaf.df)[fun_leaf.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_leaf_spp, file = "output/mvabund/fun_leaf_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_leaf.df, file = "output/mvabund/q_fun_leaf.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_leaf, file = "output/mvabund/sigfun_leaf.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(fun_litter.df, file = "output/mvabund/fun_litter.df.csv", row.names = F)	#save p-values
fun_litter_spp = colnames(fun_litter.df)[fun_litter.df[2,]<=0.05]	#Select significant p-values
write.csv(fun_litter_spp, file = "output/mvabund/fun_litter_spp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(q_fun_litter.df, file = "output/mvabund/q_fun_litter.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfun_litter, file = "output/mvabund/sigfun_litter.csv", row.names = F)	#Save list of significant ESVs


pdf(file = "figures/mvabundXtra/fun_SampleType_residuals.pdf")	#Prepare pdf file
par(mfrow = c(2,4), bty = "l", pty = "m")	#Set plotting parameters
...
write.csv(funsamp, file = "output/mvabund/funsamp.csv", row.names = T)	#Save df of significant ESVs

##Bar graph of ESV numbers per class for each sample type
pdf(file = "figures/mvabundXtra/funsamp.pdf")	#Prepare pdf file
par(mfrow=c(1, 1), mar = c(5, 5, 4, 9))	#Set margins
...
write.csv(fun_rainsamp.p.df, file = "output/mvabund/fun_rainsamp.p.df.csv", row.names = F)
sigfunrainsamp_spp = colnames(fun_rainsamp.p.df)[fun_rainsamp.p.df[4,]<=0.05]	#Select significant p-values
write.csv(sigfunrainsamp_spp, file = "output/mvabund/sigfunrainsamp_spp.csv")	#Save list of significant ESVs
...
write.csv(q_sigfunrainsamp.df, file = "output/mvabund/q_sigfunrainsamp.df.csv", row.names = F)	#Save q-values
...
write.csv(sigfunrainsamp, file = "output/mvabund/sigfunrainsamp.csv", row.names = F)	#Save list of significant ESVs
...
write.csv(sigfunrainsamp.df, file = "output/mvabund/sigfunrainsamp.df.csv", row.names = F)	#Save df
...
sigfunrainsamp.glm <- manyglm(sigfunrainsamp.abund ~ Gradient * Sample_type,
	family = "negative.binomial")	#Assess GLMs for significant ESVs
pdf(file = "figures/mvabundXtra/sigfunrainsamp_coefplot1.pdf")	#Prepare to save plot
par(mar=c(5,7,3,1))	#Change margins of imaging device
...
significant_microbes <- multi_panel_figure(width = c(178, 356),
	height = c(178, 178)) %>%
fill_panel("figures/mvabundXtra/sigbacgrad.pdf") %>%
fill_panel("figures/mvabundXtra/bacsamp.pdf") %>%
fill_panel("figures/mvabundXtra/sigfungrad.pdf") %>%
fill_panel("figures/mvabundXtra/funsamp.pdf")
